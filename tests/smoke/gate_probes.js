...
(async () => {
  ...
  await browser.close();
  rows.push({ id: 'G-15', verdict: 'EXTERNAL', obs: 'not probed here: reload behaviour is covered by tests/smoke/smoke_run.js (C10 dice, C11 loot, C12 scripted luck, C13 purchase/batch, C19 mid-fight reload, C21 betting) - run it separately and read its report' }); // group_95 B04: no unconditional PASS
