...
# group_89 M-01: painted map backgrounds (JPEG, generated for the project; PNG originals kept outside git in _handoff/map_originals)
mkdir -p "$DIST_DIR/map"
cp assets/map/*.jpg "$DIST_DIR/map/"
