...
Фоны трёх слоёв карты (`assets/map`, в сборке `dist/map`) сгенерированы для проекта 10.09.2026 (ChatGPT 6 Astra ULTRA, встроенная генерация изображений) по брифу `audit_cycles/recheck_2026_09/BRIEF_map_art_astra.md`; оригиналы и промпты — в `assets/map/originals`. Надписей на картинках нет — подписи рисует игра на четырёх языках.
