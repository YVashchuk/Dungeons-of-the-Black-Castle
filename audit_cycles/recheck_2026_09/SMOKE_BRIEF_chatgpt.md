...
| C17 | `#1` | keyboard; phone for the second half | Tab to the 🍴/🗑 buttons in the bag, press Enter; on a phone open a sheet, press M, then Esc, Esc | 🍴/🗑 get a focus ring and work from the keyboard; the map opens over the sheet, first Esc closes the map, second the sheet; during a fight the hidden status line updates after every round (visible in the accessibility tree / screen reader) |
