...
```
  Start at §1.
    ...
    25. From §1164: click 'Повернуть Золотое кольцо на пальце → §1112'
    26. From §1112: click 'Противник замертво падает со стула → §81'
...
```
  Start at §1.
    ...
    12. From §915: click 'Убив льва, вы можете перешагнуть через него и войти → §833'
    13. From §833: click 'Пойти налево → §969'
    14. From §969: click 'Через дверь в дальнем углу → §1076'
    15. From §1076: click 'Открыть дверь и поднимаетесь по лестнице на… → §870'
    16. From §870: click 'Пойти дальше → §943'
    17. From §943: click 'Теперь перед вами две двери: дверь справа → §828'
    18. From §828: click 'Позвоните → §1135'
    19. From §1135: click 'Примите его предложение или будете драться с ним → §1050'
```
  (19 clicks total, graph: basic)
...
```
  Start at §1.
    ...
    18. From §828: click 'Позвоните → §1135'
    19. From §1135: click 'Примите его предложение или будете драться с ним → §1050'
    20. From §1050: click 'Теперь уходите → §383'
    21. From §383: click 'Попадаете в коридор, который выводит на лестницу → §1100'
    22. From §1100: click 'Открыв дверь, попадаете в короткий коридор → §671'
    23. From §671: click 'Поднявшись, вы останавливаетесь перед закрытой… → §42'
    24. From §42: click 'Открыть дверь справа → §161'
    25. From §161: click 'Решайте: свернете налево → §362'
    26. From §362: click 'Подняться по лестнице → §603'
    27. From §603: click 'Быстро взбегаете по лестнице на небольшой… → §1015'
    28. From §1015: click 'Смело подходите к двери, быстро открываете ее и → §1096'
    29. From §1096: click 'Если вы дали Гарпии зеркальце или убили ее, то → §1164'
```
...
```
  Start at §1.
    ...
    14. From §449: click 'Использовать заклятие Огня → §440'
    15. From §440: click 'Подобрать золотой ключ и идти дальше → §353'
    16. From §353: click 'Что вы сделаете: выхватите меч и будете нападать без → §942'
    17. From §942: click 'Обшарить его карманы → §462'
```
